...
import com.example.equalitygender.fragments.masyarakat.ReportDetailFragment

class MasyarakatReportAdapter(private val reportList: List<Report>) : RecyclerView.Adapter<MasyarakatReportAdapter.ReportViewHolder>() {
    ...
    inner class ReportViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(report: Report) {
            ...
            Log.d("MasyarakatReportAdapter", "mediaUrl: ${report.mediaUrl}")
            ...
            itemView.setOnClickListener {
                val fragment = ReportDetailFragment.newInstance(report.id)
